...
- **3523 вопроса** по 33 категориям направлений и технологий.
...
{
  "id": 1616,
  "categories": ["Frontend (прочее)", "Backend (прочее)"],
  "tags": ["frontend", "Performance", "middle"],
  "question": "Что такое кэширование в браузере и HTTP-заголовки?",
  "answer": "Краткий ответ",
  "explanation": "Подробное пояснение и важные ограничения",
  "examples": "Примеры кода и практические случаи"
}
```

`categories` — массив: один и тот же вопрос может входить сразу в несколько категорий (например, вопрос про Git отображается и во Frontend, и в Backend).
